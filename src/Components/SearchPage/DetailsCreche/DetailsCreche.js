...
onClick={() => { openPopup(); hideButton();  }}
      type="submit"
      className="fixed bottom-5 right-5 z-50 text-base py-3 px-[2rem] ring-4 ring-[#961715]  ld:text-lg font-semibold  text-white rounded-xl flex justify-evenly bg-[#090557] ld:py-4 ld:px-[3rem] hover:cursor-pointer hover:text-blue-950 hover:scale-105 duration-300  hover:ring-[#7e0a0a] hover:bg-[#ff6868] "
    >
      <FaCalendarAlt className="mt-1 mr-3 text-white hover:text-blue-950 " /> Faire une demande
        ...
        <div className=" ld:grid ld:grid-cols-2">
          ...
          <button
      type="submit"
      className=" z-50 ring-4 ring-[#961715] mb-4 ld:mb-0 text-lg font-semibold   text-white rounded-xl flex justify-evenly bg-[#090557] py-4  px-[4.4rem] ld:px-[3rem] hover:cursor-pointer hover:text-blue-950 ld:hover:scale-105 duration-300  hover:ring-[#7e0a0a] hover:bg-[#ff6868] "
    >
  ...
  type="submit"
  className=" z-50 ring-4 ring-[#961715]  text-lg font-semibold mt-4 ld:mt-0  text-white rounded-xl flex justify-evenly bg-[#090557] py-4 px-[3rem] hover:cursor-pointer hover:text-blue-950 ld:hover:scale-105 duration-300  hover:ring-[#7e0a0a] hover:bg-[#ff6868] "
>
     ...
     {/* debut espace localisation */}
      ...
      <div className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="ml-5 mt-5 flex justify-start  "><h2 className="text-2xl text-blue-950 font-semibold ">Note gloable : </h2><Evaluation numStars={Note} ></Evaluation>  </div>
          <div className="mx-auto  grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-rose-400 pt-8 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
