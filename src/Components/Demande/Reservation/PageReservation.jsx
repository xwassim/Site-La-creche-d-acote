  ...
  return (
    <>
      ...
      <div className="ring-4 rounded-xl ring-[#fc8280] mx-[1%] my-10 bg-rose-100 p-5 ld:mx-[10%]">
        ...
        {/* images des creches */}
        <div>
          <h1 className="text-center mt-20 text-3xl font-bold font-[Inter]  tracking-tight text-blue-950 sm:text-4xl">
            {" "}
            Images{" "}
          </h1>
          {/* Swiper */}
          <div className="flex  mx-auto max-w-[1050px] mt-7 py-5 px-0  gap-2 pio:gap-4 sm:gap-8  items-center  ">
            <div className="flex xxs:ml-[5%] ml-[1%] z-50">
              <button
                ...
                className="bg-red-100   flex  justify-center items-center xxs:w-10 xxs:h-10 w-5 h-5 rounded-full ring ring-[#fc8280] shadow focus:outline-none hover:bg-white hover:ring-rose-900 hover:scale-125 duration-300"
              >
                <svg
                  viewBox="0 0 20 20"
                  fill="currentColor"
            ...
            >
              {Images.map((slide, index) => {
                return (
                  <SwiperSlide
                    key={index}
                    className="   mx-auto   flex   my-4 bg-whtie     "
                  >
                    <img
                      className=" mx-auto mt-2  w-[95%] "
                      src={Images[index]}
                      alt=""
                    />
                  </SwiperSlide>
            ...
            <div className="flex xxs:mr-[5%] mr-[1%] z-50">
              <button
                ...
                className="bg-red-100 ring ring-[#fc8280]   flex  justify-center items-center xxs:w-10 xxs:h-10 w-5 h-5 rounded-full shadow focus:outline-none hover:bg-white hover:ring-rose-900 hover:scale-125 duration-300"
              >
                <svg
                  viewBox="0 0 20 20"
                  fill="currentColor"
    ...
    <div id='Reservation' className="   z-0 mx-[10%] mb-6 group  ">
